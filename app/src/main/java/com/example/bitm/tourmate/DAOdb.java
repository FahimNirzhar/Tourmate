...
public class DAOdb {
    ...
    public long addImage(MyImage image) {
        ...
        cv.put(DBhelper.COLUMN_Event, image.getEvent());
    ...
    public List<MyImage> getImages() {
        ...
        while (!cursor.isAfterLast()) {
            ...
            if(MyImage.getEvent()!=null && MyImage.getEvent().equals(eventname)){
    ...
    private MyImage cursorToMyImage(Cursor cursor) {
        ...
        image.setEvent(cursor.getString(
                cursor.getColumnIndex(DBhelper.COLUMN_Event)));
        return image;
    }
}
